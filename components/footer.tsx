    ...
    <footer className="bg-gradient-to-br from-white via-reccova-lightGreen to-reccova-lightViolet pt-20 pb-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <h3 className="text-2xl font-bold gradient-text mb-6">Reccova</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog" className="text-gray-600 hover:text-gray-900 transition-colors flex items-center">
              ...
              <li>
                <Link href="/contact" className="text-gray-600 hover:text-gray-900 transition-colors flex items-center">
                  <span className="bg-reccova-violet/10 w-2 h-2 rounded-full mr-2"></span>
                  Contact
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">123 Healing Street, Wellness City, WC 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@reccova.com" className="text-gray-600 hover:text-gray-900 transition-colors">
                  info@reccova.com
                </a>
              </li>
            </ul>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          ...
          <div className="text-center mt-6 text-gray-400 text-sm flex items-center justify-center">
            Made with <Heart size={14} className="mx-1 text-reccova-pink" /> for better health and wellness
          </div>
        </div>
      </div>
    </footer>
